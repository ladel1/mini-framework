  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?=CONTEXT_PATH?>">Accueil</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?=CONTEXT_PATH?>articles">Articles</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?=CONTEXT_PATH?>register">Inscription</a>
        </li>        
        <li class="nav-item">
